...
When possible, validate with Xcode build diagnostics or a full Xcode build. App-option retarget changes also run `probes/app_retarget_probe.swift` via `swiftc`. For behavior changes, manually exercise:
