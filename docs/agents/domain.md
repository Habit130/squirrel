...
- For candidate ranking, semantic memory, or LM integration, read **`CONTEXT.md`**, the relevant decisions under **`docs/adr/`**, and **`docs/reranker-public-contract.md`** for released schema keys, protocol identity fields, and blocking semantics. For the personal BGE experiment, also read **`docs/personal-experiment-profile.md`**; that path is not live enablement. For the personal Qwen + LoRA live-reranking exception, also read **`docs/adr/0005-personal-lora-live-reranking.md`**; merging that record is not live enablement.
...
├── docs/personal-experiment-profile.md
└── docs/adr/
    ...
    ├── 0004-personal-experimental-first-use.md
    └── 0005-personal-lora-live-reranking.md
```
