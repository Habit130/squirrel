...
The candidate-reranking plugin (issues #17–#21) is **not** in this repo and is not a submodule of it. Its source repo is **`Habit130/librime-llm-rerank`**, created by #17. Two ways to get the plugin binary, one per build path:
